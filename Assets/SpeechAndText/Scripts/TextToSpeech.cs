...
#if UNITY_EDITOR
#elif UNITY_IPHONE
       //orig _TAG_SettingSpeak(language, pitch, rate / 2);
        _TAG_SettingSpeak(language, 1f, rate / 2);
#elif UNITY_ANDROID
        AndroidJavaClass javaUnityClass = new AndroidJavaClass("com.starseed.speechtotext.Bridge");
       //orig  javaUnityClass.CallStatic("SettingTextToSpeed", language, pitch, rate);
        javaUnityClass.CallStatic("SettingTextToSpeed", "en-NG", 0.5f, 1.3f);
#endif
        }
