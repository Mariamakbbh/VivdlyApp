...
public class MKafrica : MonoBehaviour
{
...
//START canvas not found
    ...
    void taksFromScreen(){
      ButtonsStatus(false);
      FindObjectOfType<Modern>().allOff();
      Resources.UnloadUnusedAssets();
      System.GC.Collect();
    }
...
//START canvas found
    ...
    void canvasFound(){
      ...
      startTalking("The following visualisation is an approximate representation based upon historical evidence. Please click one of the side buttons to start your AR experience."); 
